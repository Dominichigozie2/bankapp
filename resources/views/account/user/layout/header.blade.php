<header id="page-topbar">
    <div class="navbar-header">
        <div class="d-flex">
            ...
            <button type="button" class="btn btn-sm px-3 font-size-16 d-lg-none header-item"  id="toggleSidebar" style="transition: all 0.3s;">
            ...
            <div class="dropdown d-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-end pt-0">
                    ...
                    <a class="dropdown-item" href="auth-signout-cover.html">
                        <i class="bx bx-log-out"></i> <span class="align-middle">Logout</span></a>
                </div>
            </div>
        </div>
    </div>
