...
<body x-data="{ scrolled: false }" @scroll.window="scrolled = (window.scrollY > 0)">
    ...
    <script type="module" crossorigin src="assets/js/apps-event-overview.js"></script>
    <script type="module" crossorigin src="assets/admin.bundle-9LCnK6yO.js"></script>
    <script type="module" crossorigin src="assets/layout-Ce54t42U.js"></script>
    <script type="module" crossorigin src="assets/main-1p2CIAJu.js"></script>
    <script type="module" crossorigin src="assets/js/apps-school-teachers-list.js"></script>
    <script type="module" crossorigin src="assets/js/apps-school-teachers-overview.js"></script>
    <script src="assets/libs/dayjs/dayjs.min.js"></script>
    <script src="assets/libs/dayjs/plugin/quarterOfYear.js"></script>
    <script src="assets/libs/swiper/swiper-bundle.min.js"></script>
    <script type="module" crossorigin src="assets/js/apps-school-teachers-payroll.js"></script>
    <script type="module" crossorigin src="assets/admin.bundle-9LCnK6yO.js"></script>
    <script type="module" crossorigin src="assets/js/auth-signin-basic.js"></script>
    <script type="module" crossorigin src="assets/js/pages-account-security.js"></script>
    <script type="module" crossorigin src="assets/js/pages-account-security.js"></script>
    <script type="module" crossorigin src="assets/js/pages-account-statements.js"></script>
</body>
